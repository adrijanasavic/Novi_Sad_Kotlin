...
class ShopAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val v = LayoutInflater.from(parent.context).inflate(R.layout.card_item_shop, parent, false)
        return ViewHolder(v)
    }
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val imageView: ImageView = itemView.findViewById(R.id.shop_image_card)
        val nameTextView: TextView = itemView.findViewById(R.id.shop_name_card)
        val cardView: CardView = itemView.findViewById(R.id.cardview_shop)
